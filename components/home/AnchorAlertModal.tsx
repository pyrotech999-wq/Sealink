  ...
  if (mounted && isMobile) {
    return (
      <MobileAnchorAlertModal
        open={open}
        onClose={onClose}
        emergencyDisableLiveMapApis={emergencyDisableLiveMapApis}
        sharing={sharing}
        hasFix={hasFix}
        pos={pos}
        horizontalAccuracyM={horizontalAccuracyM}
        anchorGpsQuality={anchorGpsQuality}
        showIOSPreciseHint={showIOSPreciseHint}
        deviceId={deviceId}
        config={config}
        monitor={monitor}
        onUpdate={onUpdate}
        onMonitorRolesSaved={onMonitorRolesSaved}
        isAdmin={isAdmin}
      />
    );
  }

...
export default function TermsSwitcher() {
      ...
      <div className="flex min-h-screen flex-col bg-gradient-to-b from-[#030816] via-[#09152a] to-[#020510] text-slate-200 p-5 pb-[max(2rem,env(safe-area-inset-bottom))]">
        ...
        <div className="shrink-0 flex items-center justify-between pt-[calc(env(safe-area-inset-top)+1rem)] pb-3 border-b border-white/[0.05]">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[10px] font-bold tracking-widest uppercase text-cyan-400">Legal Console</span>
          </div>
        </div>

        {/* Title */}
        <div className="py-4 shrink-0">
          <h1 className="text-lg font-extrabold tracking-tight text-white">Terms of Use</h1>
          <p className="text-[10px] text-slate-400 mt-1 leading-relaxed">
            Please read these requirements carefully before operating SeaLink telemetry or alarms.
          </p>
        </div>
        ...
        <div className="flex-1 overflow-y-auto space-y-4 pr-1">
          {/* Safety Notice card */}
          <aside className="rounded-2xl border border-amber-500/20 bg-amber-500/5 p-4 flex gap-3 shadow-inner">
            <AlertTriangle size={18} className="text-amber-400 shrink-0 mt-0.5 animate-pulse" />
            <div>
              <p className="text-xs font-bold text-amber-400 uppercase tracking-widest">Important Safety Notice</p>
              <div className="mt-2 text-[10px] leading-relaxed text-slate-300 space-y-2">
                <p>SeaLink and all anchor alarm notifications are provided for informational purposes only.</p>
                <p>Must not be relied upon for life, safety, emergency response, navigation, collision avoidance, or anchoring decisions.</p>
                <p>GPS position data and background app activity may be delayed, inaccurate, or unavailable at any time.</p>
                <p>You are solely responsible for maintaining a proper watch and verifying positions using appropriate marine safety gear.</p>
              </div>
            </div>
          </aside>

          {/* Core Terms text in glass card */}
          <div className="bg-white/[0.02] border border-white/[0.05] p-5 rounded-[24px] shadow-lg text-[11px] leading-relaxed text-slate-300 space-y-5">
            <p className="text-xs text-slate-400">
              Last updated April 2026. These terms apply to SeaLink ("we", "us", "our") and you ("you", "your", "user").
            </p>

            {/* Read before use */}
            <div className="rounded-xl border border-amber-500/10 bg-amber-500/[0.02] p-3 space-y-2.5">
              <p className="font-extrabold text-amber-400 uppercase tracking-wider text-[10px]">Read before use:</p>
              <ul className="list-disc pl-4 space-y-2 text-[10.5px]">
                <li><strong className="text-white">Recreational use only.</strong> SeaLink is not a navigational aid, safety system, or substitute for qualified maritime judgment.</li>
                <li><strong className="text-white">Do not use for planning trips or sailing.</strong> Voyage planning must rely exclusively on official meteorological and maritime sources.</li>
                <li><strong className="text-white">Official charts required.</strong> Casual overlays are for entertainment only. Always carry approved electronic or paper charts.</li>
                <li><strong className="text-white">Emergency communications.</strong> The app is not a replacement for VHF, distress radios, or calling the coastguard.</li>
              </ul>
            </div>

            <div className="space-y-4">
              <section>
                <h3 className="font-bold text-white text-xs">1. Acceptance and acknowledgements</h3>
                <p className="mt-1">By creating an account, signing in, or using the Service, you confirm you have read, understood, and agree to these terms. If you do not agree, do not use the Service.</p>
              </section>

              <section>
                <h3 className="font-bold text-white text-xs">2. Nature of the Service</h3>
                <p className="mt-1">All features are provided for casual recreational curiosity. The Service does not create a duty of care, watch, or rescue obligation on our part.</p>
              </section>

              <section>
                <h3 className="font-bold text-white text-xs">3. No voyage planning; no reliance</h3>
                <p className="mt-1">You agree not to use the Service as any part of passage planning, sail plans, or compliance with carriage requirements.</p>
              </section>

              <section>
                <h3 className="font-bold text-white text-xs">4. Weather and environmental data</h3>
                <p className="mt-1">Forecasts and tide indicators are compiled from third-party models (such as GFS) and may be delayed or inaccurate. Model attributions do not imply endorsements.</p>
              </section>

              <section>
                <h3 className="font-bold text-white text-xs">5. Maps, positioning, and charts</h3>
                <p className="mt-1">Basemaps are not nautical charts. Device GNSS can be inaccurate or absent. You are responsible for carrying licensed charts.</p>
              </section>

              <section>
                <h3 className="font-bold text-white text-xs">6. Community content and broadcasts</h3>
                <p className="mt-1">Vessel markers, chat messages, and broadcasts are user-generated. We are under no obligation to moderate or verify their safety.</p>
              </section>

              <section>
                <h3 className="font-bold text-white text-xs">7. Emergency procedures</h3>
                <p className="mt-1">Nothing in these terms replaces recognized distress radio frequencies (VHF Channel 16) or official emergency lines. False distress is unlawful.</p>
              </section>

              <section>
                <h3 className="font-bold text-white text-xs">8. Accounts and security</h3>
                <p className="mt-1">You must keep credentials confidential. Circumventing subscription limits or sharing account access is prohibited.</p>
              </section>

              <section>
                <h3 className="font-bold text-white text-xs">9. Disclaimers and limits of liability</h3>
                <p className="mt-1">The Service is provided "as is". To the maximum extent allowed by law, we exclude liability for incidental, special, or consequential damages.</p>
              </section>
            </div>

            <p className="pt-3 border-t border-white/[0.05] text-[9.5px] text-slate-500 text-center">
              SeaLink encourages every crew member to carry safety beacons and VHF radios.
            </p>
          </div>
